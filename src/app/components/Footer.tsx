...
const Footer = () => {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="border-t border-white/5 pt-4 flex justify-between items-center pb-4">
        <a
        ...
        <div className="flex gap-x-3 items-center">
          ...
          >
            <span className="sr-only">WiseOldMan.net</span>
            <img
              src="https://oldschool.runescape.wiki/images/Blue_partyhat.png?00685"
              alt="WiseOldMan.net"
